...
public class FrmAlumnoNuevoController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        lblTextoFrm.setText(Variables.textoFrmAlumno);  //Envíamos el texto de la variable al campo label de nuestra ventana
    ...
    private void guardarDatos() {
        ...
        try {
            ...
            Logger.getLogger(FrmAlumnoNuevoController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
